...
from hfdb.queries import get_regular_season_stats_by_player_key, get_playoff_stats_by_player_key
...
class PlayerStatsPlayoff(Resource):
  def get(self, player_key):
    stats_for_player = get_playoff_stats_by_player_key(player_key)
